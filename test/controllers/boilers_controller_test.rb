...
class BoilersControllerTest < ActionController::TestCase
  ...
  test "should create boiler" do
    assert_difference('Boiler.count') do
      post :create, boiler: { facility_id: @boiler.facility_id, make: @boiler.make, type: @boiler.type, year: @boiler.year }
    end
  ...
  test "should update boiler" do
    patch :update, id: @boiler, boiler: { facility_id: @boiler.facility_id, make: @boiler.make, type: @boiler.type, year: @boiler.year }
    assert_redirected_to boiler_path(assigns(:boiler))
  end
